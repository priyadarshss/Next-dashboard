...
const TopCards = () => {
  return (
    <div className='grid lg:grid-cols-5 gap-4 p-4'>
      <div className='lg:col-span-2 col-span-1 bg-gray-900 flex justify-between w-full border border-gray-700 p-4 rounded-lg'>
      ...
      <div className='lg:col-span-2 col-span-1 bg-gray-900 flex justify-between w-full border border-gray-700 p-4 rounded-lg'>
        <div className='flex flex-col w-full pb-4'>
          <p className='text-2xl font-bold'>$1,117,840</p>
